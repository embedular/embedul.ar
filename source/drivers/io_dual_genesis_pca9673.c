...
void IO_DUAL_GENESIS_PCA9673_Attach (struct IO_DUAL_GENESIS_PCA9673 *const G)
{
    ...
    INPUT_MAP_BIT (GP1, Down, IO_DUAL_GENESIS_INB_Down);
    INPUT_MAP_BIT (GP1, Up, IO_DUAL_GENESIS_INB_Up);
    INPUT_MAP_BIT (GP1, Start, IO_DUAL_GENESIS_INB_Start);
    INPUT_MAP_BIT (GP1, Select, IO_DUAL_GENESIS_INB_Mode);
    INPUT_MAP_BIT (GP1, A, IO_DUAL_GENESIS_INB_A);
    INPUT_MAP_BIT (GP1, B, IO_DUAL_GENESIS_INB_B);
    INPUT_MAP_BIT (GP1, C, IO_DUAL_GENESIS_INB_C);
    INPUT_MAP_BIT (GP1, X, IO_DUAL_GENESIS_INB_X);
    ...
    INPUT_MAP_BIT (GP2, Down, IO_DUAL_GENESIS_INB_Down);
    INPUT_MAP_BIT (GP2, Up, IO_DUAL_GENESIS_INB_Up);
    INPUT_MAP_BIT (GP2, Start, IO_DUAL_GENESIS_INB_Start);
    INPUT_MAP_BIT (GP2, Select, IO_DUAL_GENESIS_INB_Mode);
    INPUT_MAP_BIT (GP2, A, IO_DUAL_GENESIS_INB_A);
    INPUT_MAP_BIT (GP2, B, IO_DUAL_GENESIS_INB_B);
    INPUT_MAP_BIT (GP2, C, IO_DUAL_GENESIS_INB_C);
    INPUT_MAP_BIT (GP2, X, IO_DUAL_GENESIS_INB_X);
    INPUT_MAP_BIT (GP2, Y, IO_DUAL_GENESIS_INB_Y);
    INPUT_MAP_BIT (GP2, Z, IO_DUAL_GENESIS_INB_Z);
}

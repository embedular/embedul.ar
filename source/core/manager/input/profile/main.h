...
#define INPUT_PROFILE_MAIN_RANGE_MAP     1
...
enum INPUT_PROFILE_MAIN_Bit
{
    ...
    INPUT_PROFILE_MAIN_Bit_PointerPressed,
    INPUT_PROFILE_MAIN_Bit__COUNT
};


enum INPUT_PROFILE_MAIN_Range
{
    INPUT_PROFILE_MAIN_Range_PointerX,
    INPUT_PROFILE_MAIN_Range_PointerY,
    INPUT_PROFILE_MAIN_Range_PointerOverScreenType,
    INPUT_PROFILE_MAIN_Range__COUNT
};

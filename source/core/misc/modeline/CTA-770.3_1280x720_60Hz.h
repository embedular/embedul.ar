/*
  ...
  CTA-770.3 1280x720 60 hz display modeline.
...
Line       *--------+         +----------|---------------------------------*
Pixels         110       40       220                 1280
ns           1481.48   538.72   2962.96              17239    (Total 22.22 us)
================================================================================
                          VSYNC
                      +-*-*-*...*-+
...
#define MODELINE_SIGNAL_STR     "1280x720 60 Hz (CTA-770.3)"
...
#define MODELINE_HSYNCEND       1430   // HTOTAL-HSYNCEND = Back Porch

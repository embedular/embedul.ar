...
struct OS           * g_OS                      = (struct OS *) 0;
volatile uint32_t   g_OS_SchedulerPending       = 0;
volatile uint32_t   g_OS_SchedulerTickBarrier   = 0;
volatile uint32_t   g_OS_SchedulerTicksMissed   = 0;
const char          * g_OS_TaskBootDescription  = "BOOT";
const char          * g_OS_TaskIdleDescription  = "IDLE";
TIMER_TickHookFunc  g_OS_PrevTickHookFunc       = (TIMER_TickHookFunc) 0;

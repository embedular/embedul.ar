...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, EXP_PIN5_Pin|EXP_PIN7_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, OUT_6_Pin|OUT_5_Pin|OUT_4_Pin|OUT_3_Pin
                          |GPIO_PIN_13|OUT_1_Pin|IN_CLK_Pin|A6_INT_Pin
                          |A6_ON_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : S800_DTR_Pin S800_ON_Pin OUT_EN_Pin ESP_RESET_Pin */
  ...
  /*Configure GPIO pins : EXP_PIN1_Pin EXP_PIN3_Pin IN_PS_Pin */
  ...
  /*Configure GPIO pins : EXP_PIN5_Pin EXP_PIN7_Pin LED1_Pin LED2_Pin
                           LED3_Pin LED4_Pin */
  ...
  /*Configure GPIO pins : EXP_PIN9_Pin EXP_PIN11_Pin EXP_PIN10_Pin EXP_PIN8_Pin
                           EXP_PIN6_Pin EXP_PIN4_Pin EXP_PIN2_Pin RS845_RE_Pin
                           RS485_DE_Pin */
  ...
  /*Configure GPIO pins : IN_READ_Pin SD_CD_Pin */
  GPIO_InitStruct.Pin = IN_READ_Pin|SD_CD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : OUT_6_Pin OUT_5_Pin OUT_4_Pin OUT_3_Pin
                           PD13 OUT_1_Pin A6_INT_Pin A6_ON_Pin */
  GPIO_InitStruct.Pin = OUT_6_Pin|OUT_5_Pin|OUT_4_Pin|OUT_3_Pin
                          |GPIO_PIN_13|OUT_1_Pin|A6_INT_Pin|A6_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : IN_CLK_Pin */

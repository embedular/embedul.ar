...
{
    MIO_RegisterGateway (MIO_Dir_Input, (struct IO *) K, 0);

    // Default keymappings
    MIO_MAP_INPUT_BIT (GP1, Right, SDL_SCANCODE_RIGHT);
    MIO_MAP_INPUT_BIT (GP1, Left, SDL_SCANCODE_LEFT);
    MIO_MAP_INPUT_BIT (GP1, Down, SDL_SCANCODE_DOWN);
    MIO_MAP_INPUT_BIT (GP1, Up, SDL_SCANCODE_UP);
    MIO_MAP_INPUT_BIT (GP1, Start, SDL_SCANCODE_KP_ENTER);
    MIO_MAP_INPUT_BIT (GP1, Select, SDL_SCANCODE_KP_PLUS);
    MIO_MAP_INPUT_BIT (GP1, A, SDL_SCANCODE_KP_1);
    MIO_MAP_INPUT_BIT (GP1, B, SDL_SCANCODE_KP_2);
    MIO_MAP_INPUT_BIT (GP1, C, SDL_SCANCODE_KP_3);
    MIO_MAP_INPUT_BIT (GP1, X, SDL_SCANCODE_KP_4);
    MIO_MAP_INPUT_BIT (GP1, Y, SDL_SCANCODE_KP_5);
    MIO_MAP_INPUT_BIT (GP1, Z, SDL_SCANCODE_KP_6);

    MIO_MAP_INPUT_BIT (GP2, Right, SDL_SCANCODE_D);
    MIO_MAP_INPUT_BIT (GP2, Left, SDL_SCANCODE_A);
    MIO_MAP_INPUT_BIT (GP2, Down, SDL_SCANCODE_S);
    MIO_MAP_INPUT_BIT (GP2, Up, SDL_SCANCODE_W);
    MIO_MAP_INPUT_BIT (GP2, Start, SDL_SCANCODE_RETURN);
    MIO_MAP_INPUT_BIT (GP2, Select, SDL_SCANCODE_BACKSLASH);
    MIO_MAP_INPUT_BIT (GP2, A, SDL_SCANCODE_J);
    MIO_MAP_INPUT_BIT (GP2, B, SDL_SCANCODE_K);
    MIO_MAP_INPUT_BIT (GP2, C, SDL_SCANCODE_L);
    MIO_MAP_INPUT_BIT (GP2, X, SDL_SCANCODE_U);
    MIO_MAP_INPUT_BIT (GP2, Y, SDL_SCANCODE_I);
    MIO_MAP_INPUT_BIT (GP2, Z, SDL_SCANCODE_O);
}

...
static StaticTask_t xOeriodicControlBlock;

/* Semaphore buffer for xSemaphoreCreateCountingStatic() */
StaticSemaphore_t xCountingSemaphoreBuffer;
...
( void ) param;
    ...
    xTaskCreateStatic( vPeriodicTask, "Periodic", 1000, NULL, 1, xPeriodicStack, &xOeriodicControlBlock );
